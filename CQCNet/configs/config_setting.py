...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.1,
        'load_ckpt_path': './results/bcedicefocal_isic16/checkpoints/best-epoch271-loss0.4001.pth',
    }

    datasets = 'cervix_acid_split'
    if datasets == 'isic18':
    ...
    elif datasets == 'cervix_acid_split':
        data_path = './data/cervix_acid_split/'
    elif datasets == 'polyp':
    ...
    elif datasets == 'bbc005':
        data_path = './data/bbc005/'
    elif datasets == 'ph2':
        data_path = './data/ph2/'
    else:
        raise Exception('datasets in not right!')

    criterion = UncertaintyBceDiceFocal()
